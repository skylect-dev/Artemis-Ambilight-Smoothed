...
{
    public sealed class AmbilightSmoothedScreenCaptureService : IScreenCaptureService
    {
        ...
        public AmbilightSmoothedScreenCaptureService(IScreenCaptureService screenCaptureService)
        {
        ...
        public IScreenCapture GetScreenCapture(Display display)
        {
            lock (_screenCaptures)
            {
                if (!_screenCaptures.TryGetValue(display, out IScreenCapture? screenCapture))
                    _screenCaptures.Add(display, screenCapture = new AmbilightSmoothedScreenCapture(_screenCaptureService.GetScreenCapture(display)));
